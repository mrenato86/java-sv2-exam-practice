...
class ExamLearningsTest {
    ...
    void init() {
        ...
        examLearnings.readFromFile(Paths.get("src/test/resources/potpotvizsga/examlearnings.csv"));
    }
    ...
    void testReadFromNotExistingFile() {
        Exception ex = assertThrows(IllegalStateException.class,
                () -> examLearnings.readFromFile(Paths.get("src/test/resources/potpotvizsga/xyz.csv")));
