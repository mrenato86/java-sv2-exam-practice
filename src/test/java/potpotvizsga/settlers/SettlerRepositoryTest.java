...
class SettlerRepositoryTest {
    ...
    void init() {
        try {
            ...
            dataSource.setUrl("jdbc:mariadb://localhost:3306/e_settlers?useUnicode=true");
        ...
        Flyway fw = Flyway.configure().locations("potpotvizsga/db/migration").dataSource(dataSource).load();
        fw.clean();
        fw.migrate();
